...
This checkout is an identity-only baseline for follow-on MEGA RECORDER work. No
speculative product behavior is included here. The upstream `LICENSE` and
`THIRD-PARTY-NOTICES.md` files are retained as the governing attribution and
license records.
